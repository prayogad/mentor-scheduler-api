...
export class SessionService {
    ...
    async checkSessionMustExist(sessionId: number, mentorId: number): Promise<MentorSession> {
    ...
    async book(user: User, request: BookSessionRequest): Promise<BookSessionResponse> {
        const bookRequest: BookSessionRequest = this.validationService.validate(SessionValidation.BOOK, request);
        await this.checkStudentMustExist(user.id);
        await this.checkSessionMustExist(bookRequest.session_id, bookRequest.mentor_id);
